<template>
  <div class="Register">
    ...
    <div class="Header">
      ...
      <div class="antialiased sans-serif bg-white dark:bg-dark-main mt-44">
        <div x-cloak>
          <form @submit.prevent="Register">
            <div class="max-w-3xl mx-auto px-4 py-10">
              <div v-if="step === 'complete'">
                <div
                  class="bg-white rounded-lg p-10 mt-40 flex items-center shadow justify-between"
                >
                  <div>
                    <svg
                    ...
                    <h2
                      class="text-2xl mb-4 text-gray-800 text-center font-bold"
                    >
              ...
              <div v-if="step != 'complete'">
                <!-- Top Navigation -->
                <div class="border-b-2 py-4 border-gray-200 dark:border-white">
                  <div
                    class="uppercase tracking-wide text-xs font-bold text-gray-500 mb-1 leading-tight"
                    v-text="`Etapa: ${step} de 3`"
                  ></div>
                  <div
                  ...
                  >
                    <div class="flex-1">
                      <div v-if="step === 1">
                        <div
                          class="text-lg font-bold text-gray-700 dark:text-white leading-tight"
                        >
                          Seu perfil
                        </div>
                      </div>
                    ...
                    <div class="flex items-center md:w-64">
                      <div
                        class="w-full bg-white rounded-full mr-2 dark:bg-dark-main"
                      >
                        <div
                ...
                <div class="py-10">
                  <div v-if="step === 1">
                    <div class="mb-5 text-center">
                      ...
                      <label
                        for="fileInput"
                        type="button"
                        class="cursor-pointer inine-flex justify-between items-center focus:outline-none py-2 px-4 rounded-lg shadow-sm text-left border dark:border-dark-third text-gray-800 dark:text-gray-50 bg-white hover:bg-gray-100 dark:bg-dark-second dark:hover:bg-dark-third font-medium"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div v-if="step === 2">
                    <div class="mb-5">
                      <label
                        for="password"
                        class="font-bold mb-1 text-gray-700 dark:text-white block"
                        >Configurar senha</label
                      >
                      <div class="text-gray-600 dark:text-gray-200 mt-2 mb-4">
                        Por favor, crie uma senha segura incluindo a seguinte
                        critérios abaixo..
                      ...
                      <div class="relative">
                        <input
                          ...
                          class="w-full px-4 py-3  rounded-lg border outline-none focus:border-blue-600 text-black dark:text-white dark:bg-dark-third border-dark-txt dark:border-dark-second dark:focus:border-blue-600"
                        ...
                        >
                          <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                            class="w-6 h-6 fill-current text-gray-500 dark:text-white"
                            viewBox="0 0 24 24"
                          >
                            <path
                  ...
                  <div v-if="step === 3">
                    <div class="mb-5">
                      ...
                      <div class="flex">
                        <label
                          class="flex justify-start items-center text-truncate rounded-lg bg-white dark:bg-dark-third  pl-4 pr-6 py-3 shadow-xl mr-4"
                        >
                          ...
                          <div
                            class="select-none text-gray-800 dark:text-gray-50"
                          >
                            Masculino
                          </div>
                        </label>
                        <label
                          class="flex justify-start items-center text-truncate rounded-lg bg-white dark:bg-dark-third pl-4 pr-6 py-3 shadow-xl"
                        >
                          <div class="text-teal-600 mr-3">
                            <input
                              type="radio"
            ...
            <!-- Bottom Navigation -->
            <div
              class="fixed bottom-0 left-0 right-0 py-5 bg-gray-50 dark:bg-dark-second shadow-md"
              v-if="step != 'complete'"
            >
  ...
  methods: {
    Register() {
      User.register(this.user)
        .then(() => {
          User.login(this.user.email, this.user.password).then((response) => {
    ...
    NextPage() {
      ...
      if (this.step === 1) {
        if (this.user.name && this.user.email && this.user.name.length >= 3) {
          this.step++;
        }
        ...
        if (!this.user.name) {
          ...
          this.errors["name"] = "Ops, Insira um nome maior!";
        }

        if (!this.user.email) {
          this.errors["email"] = "O campo nome é obrigatório!";
        }
      } else if (this.step === 2) {
